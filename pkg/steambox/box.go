...
func (b *Box) GetPlayTime(ctx context.Context, steamID uint64, multiLined bool, ignoreAppIdMap map[uint32]string, appendAppIdMap map[uint32]string, appID ...uint32) ([]string, error) {
